...
from lightrag.api.routers.prompt_config import router as prompt_config_router
...
def create_app(args):
    ...
    # Add prompt configuration routes
    app.include_router(prompt_config_router, prefix="/api", tags=["Prompt Configuration"])
